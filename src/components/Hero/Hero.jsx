  ...
  return (
    <section className="hero-section">
        <div className="container-xxl h-100 d-flex flex-column align-items-center justify-content-center">
            <h2 className="text-white text-capitalize text-center fw-bold">Are you a supplier?</h2>
            <h2 className="text-white text-capitalize text-center fw-normal">Explore matching opportunities.</h2>
            <SearchPanel />
